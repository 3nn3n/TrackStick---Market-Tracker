...
const UserDropdown = () => {
  ...
  const handleSignout = async () => {
    // Perform sign-out logic here (e.g., clear tokens, call API, etc.)
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="text-gray-400 mr-6 w-56 bg-gray-700 border-gray-700">
        <DropdownMenuLabel>
